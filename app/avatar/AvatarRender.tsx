...
export function AvatarRender({ config, size = 168, tattoo = null }: { config?: Partial<AvatarConfig> | null; size?: number; tattoo?: string | null }) {
  ...
  const head =
    ...
    c.face === "long" ? <ellipse cx="100" cy="98" rx="38" ry="54" fill={skin} /> :
  ...
  const hairBack =
    ...
    c.hair === "afro" ? <circle cx="100" cy="74" r="58" fill={hair} /> :
    c.hair === "ponytail" ? <g fill={hair}><path d="M120 70 C150 86 150 140 132 168 L120 164 C134 138 130 96 116 84 Z" /></g> :
    c.hair === "curls" ? <g fill={hair}><circle cx="60" cy="92" r="14" /><circle cx="140" cy="92" r="14" /><circle cx="64" cy="118" r="12" /><circle cx="136" cy="118" r="12" /></g> :
    c.hair === "braids" ? <g fill={hair}><path d="M62 90 L54 170 L70 170 L74 96 Z" /><path d="M138 90 L146 170 L130 170 L126 96 Z" /></g> :
    null;
  ...
  const hairFront =
    ...
    c.hair === "afro" ? <path d="M60 80 C60 52 140 52 140 80 C136 70 128 64 100 64 C72 64 64 70 60 80 Z" fill={hair} /> :
    c.hair === "curls" ? <g fill={hair}><circle cx="76" cy="58" r="14" /><circle cx="100" cy="52" r="15" /><circle cx="124" cy="58" r="14" /><circle cx="62" cy="74" r="12" /><circle cx="138" cy="74" r="12" /></g> :
    c.hair === "ponytail" ? <path d="M58 86 C58 52 142 52 142 86 C140 72 132 62 100 62 C68 62 60 72 58 86 Z" fill={hair} /> :
    c.hair === "braids" ? <path d="M58 84 C58 52 142 52 142 84 C140 70 132 60 100 60 C68 60 60 70 58 84 Z" fill={hair} /> :
  ...
  const shoulders =
    ...
    c.outfit === "cloak" ? <g><path d="M34 224 C34 176 166 176 166 224 Z" fill={outfit} /><path d="M100 182 L100 224" stroke="#caa24e" strokeWidth="2" /><circle cx="100" cy="188" r="5" fill="#caa24e" /></g> :
    c.outfit === "tee" ? <g><path d="M46 224 C46 184 154 184 154 224 Z" fill={outfit} /><path d="M84 184 Q100 196 116 184" fill="none" stroke="#9fb0b6" strokeWidth="3" /></g> :
    ...
    c.outfit === "lace" ? <g><path d="M46 224 C46 182 154 182 154 224 Z" fill={outfit} /><path d="M70 186 Q100 200 130 186" fill="none" stroke="#caa24e" strokeWidth="2" /><circle cx="86" cy="204" r="2" fill="#caa24e" /><circle cx="100" cy="208" r="2" fill="#caa24e" /><circle cx="114" cy="204" r="2" fill="#caa24e" /></g> :
  ...
  return (
    <svg viewBox="0 0 200 224" width={size} height={size * 224 / 200} role="img" aria-label="avatar">
      <defs>
        <clipPath id="av-clip"><rect x="6" y="6" width="188" height="212" rx="14" /></clipPath>
